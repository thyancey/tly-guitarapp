...
const store = {
  ...
  actions: {
    ...
    setKeyAndScale: ({ fretChanges, musicKey, scale, chord, instrument, keyFinderNotes }, newMusicKey, newScale) => {
      const fretMatrix = getFretMatrix(newMusicKey, newScale, chord, instrument, []);
